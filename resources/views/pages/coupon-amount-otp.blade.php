                            ...
                            <form class="mb-30" method="post" action="{{url('/coupon/otp/submit')}}">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a href="{{url('/resend/code/coupon/confirm/mobile-'.$select_transaction_info->branch_mobile.'/otp-'.$select_transaction_info->coupon_secret_code)}}" class="btn btn-lg btn-warning btn-rounded pull-left">Again Send </a>
                                        <input type="submit" value="Confirm" class="btn btn-lg btn-rounded mr-10 pull-right">
