                        ...
                        <section class="section checkout-area panel prl-30 pt-20 pb-40">
                            ...
                            <form class="mb-30" method="post" action="{{url('/coupon/amount/submit')}}">
                                ...
                                <div class="row">
                                    ...
                                    <a href="{{url('/')}}" class="btn btn-lg btn-warning btn-rounded pull-left">Cancel </a>
                            ...
                            <form class="mb-30" method="post" action="{{url('/coupon/otp/submit')}}">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a href="#" class="btn btn-lg btn-warning btn-rounded pull-left">Again Send </a>
                    ...
                    <aside class="sidebar blog-sidebar">
                        <div class="row row-tb-10">
                            <div class="col-xs-12">
                                ...
                                <div class="panel-body" id="coupon_list">
