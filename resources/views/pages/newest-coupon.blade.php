                ...
                <section class="section deals-area ptb-30">
                    <header class="panel ptb-15 prl-20 pos-r mb-30">
                        ...
                        <ul class="list-control-view list-inline">
                            <li><i class="fa fa-bars"></i> New Coupon
                            </li>
                    ...
                    <div class="row row-masnory row-tb-20">
    					...
    					@if(!empty($new_coupon_info) && count($new_coupon_info)>0)
                        @foreach($new_coupon_info as $key =>$list)
                    ...
                    {{isset($new_coupon_pagination) ? $new_coupon_pagination:''}}
            </div>
        </div>
        <!-- End Page Container -->
