        ...
        <main id="mainContent" class="main-content">
            ...
            <div class="page-container ptb-10">
                <div class="container">
                    ...
                    @if(!empty($select_sub_category_info) && count($select_sub_category_info)>0)
                        <header class="panel ptb-15 prl-20 pos-r mb-30">

                            <!-- List Control View -->
                            <ul class="list-control-view list-inline">
                                <li><i class="fa fa-bars"></i> All {{($select_sub_category_info->sub_category_name)? ($select_sub_category_info->sub_category_name):''}} Shop
                                </li>
                        ...
                        <div class="row row-masnory row-tb-20">
                            <?php
                            	$all_merchant_coupon_info=\DB::table('tbl_coupon')
                                        ->leftjoin('tbl_merchant','tbl_coupon.coupon_merchant_id','=','tbl_merchant.merchant_id')
                                        ->where('tbl_coupon.coupon_sub_category_id',$sub_category_id)
    						...
    						@if(!empty($all_merchant_coupon_info) && count($all_merchant_coupon_info)>0)
                            @foreach($all_merchant_coupon_info as $key =>$list)
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="deal-single panel">
                                    ...
                                    <div id="printOnly">
                                        <div>
                                            <a href="{{url('/merchant/branch-view/page/mid-'.$max_discount_branch->merchant_id)}}" class="btn btn-sm btn-block"> {{($max_discount_branch->merchant_name)?($max_discount_branch->merchant_name):''}} All Coupon
                                            </a>
                                        </div>
                                    </div>
                                    <div class="bg-white pt-20 pl-20 pr-15">
    					         	...
    					         	<a href="{{url('/merchant/branch-view/page/mid-'.$max_discount_branch->merchant_id)}}">{{$max_discount_branch->merchant_name}}</a>
    					        </h3>
						
						<div class="des_height">
                                                	<p class="text-muted mb-20"><strong> Description : </strong>{{substr($max_discount_branch->merchant_description,0,120)}}</p>
						</div>
                                            </div>
                    ...
                    @else
                        <header class="panel ptb-15 prl-20 pos-r mb-30">
                            ...
                            <ul class="list-control-view list-inline">
                                <li><i class="fa fa-bars"></i> All Shop
                                </li>

                            </ul>

                            <div class="right-10 pos-tb-center">
                                <a class="btn btn-o btn-xs pos-a right-10 pos-tb-center" href="{{url('/home')}}">Views All</a>
                            </div>
                        </header>
