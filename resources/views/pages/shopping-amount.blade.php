        ...
        <div class="container">
            <div class="row row-rl-10 row-tb-20">
                ...
                <div class="page-content col-xs-12 col-sm-8 col-md-4">
                    @if(isset($select_transaction_info) && ($select_transaction_info->coupon_status =='-1'))
                        <section class="section checkout-area panel prl-30 pt-20 pb-40">
                            <h2 class="h3 mb-20 h-title">Amount Information</h2>
                            <form class="mb-30" method="post" action="{{url('/coupon/amount/submit')}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="coupon_code" value="{{$select_transaction_info->coupon_code}}">
                                    	...
                                    	<input type="submit" value="Submit" class="btn btn-lg btn-rounded mr-0 pull-right">
                                    </div>
                    ...
                    @elseif(isset($select_transaction_info) && ($select_transaction_info->coupon_status =='1'))

                        <section class="section checkout-area panel prl-30 pt-20 pb-40">
                            <h2 class="h3 mb-20 h-title">Please Submit OTP</h2>
                            <form class="mb-30" method="post" action="{{url('/coupon/otp/submit')}}">
                                <input type="hidden" name="_token" value="{{csrf_token()}}">
                                <div class="row">
                                    <div class="col-md-12">

                                        <a href="{{url('/coupon/amount/edit/tid-'.$select_transaction_info->coupon_transaction_id)}}" class="btn btn-lg btn-block btn-teal">Change Amount</a>

                                        <div class="form-group">
                                            <label>OTP</label>
                                            <input type="text" name="coupon_otp" class="form-control" placeholder="Enter OTP">
                                            <input type="hidden" name="coupon_code" value="{{$select_transaction_info->coupon_code}}">
                                            <input type="hidden" name="customer_mobile" value="{{$select_transaction_info->customer_mobile}}">
                                            <input type="hidden" name="coupon_transaction_id" value="{{$select_transaction_info->coupon_transaction_id}}">
                                        ...
                                        <div class="pull-right">
                                            <a href="{{url('/resend/code/coupon/confirm/mobile-'.$select_transaction_info->branch_mobile.'/otp-'.$select_transaction_info->coupon_secret_code.'/cmobile-'.$select_transaction_info->customer_mobile.'/amount-'.$select_transaction_info->coupon_shopping_amount.'/damount-'.$select_transaction_info->coupon_discount_amount)}}" class="btn btn-lg btn-warning btn-rounded pull-left">Resend</a>
                                            <input type="submit" value="Confirm" class="btn btn-lg btn-rounded mr-0 pull-right">
                                        </div>
