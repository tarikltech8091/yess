	...
	<div class="col-md-5">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<form action="{{url('/dashboard/social/site/update/sid-'.$selest_social_site_info->setting_id)}}" method="POST" enctype="multipart/form-data">
					<input type="hidden" name="_token" value="{{csrf_token()}}">
					<?php $setting_meta_field_value= unserialize($selest_social_site_info->setting_meta_field_value); ?>

					<div class="form-group">
						<label>Social Site Name</label>
						<input type="text" class="form-control" name="social_site_name" value="{{$setting_meta_field_value[0]?$setting_meta_field_value[0]:''}}" required="">
					</div>
					<div class="form-group">
						<label>Social Site Url</label>
						<input type="text" class="form-control" name="social_site_url" value="{{$setting_meta_field_value[1]?$setting_meta_field_value[1]:''}}" required="">
					</div>


					<input class="btn btn-teal pull-right" type="submit" value="Add">
				</form>
			</div>
		</div>
	</div>
