	...
	<div class="row margin_top_20">
		<div class="col-sm-6">
			...
			<div class="panel panel-default">
				...
				<form method="post" action="{{url('/dashboard/sub-category')}}" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label> Sub Category Name <span class="symbol required"></span></label>
				...
				<div class="table-responsive">
					...
					<tbody>
						...
						<tr >
							...
							<td>
							@if(($list->sub_category_status) == 1)
							<button class="btn btn-primary btn-xs sub_category_status col-md-12" data-id="{{$list->sub_category_id}}" data-action="-1">Block</button>
							@else
							<button class="btn btn-danger btn-xs sub_category_status col-md-12" data-id="{{$list->sub_category_id}}" data-action="1">Active</button>
							@endif
							</td>
							<td>
