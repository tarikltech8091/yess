...
<!-- 		<div id="dashboard">
		...
		<div class="col-md-3" onclick="location.href='{{url('/dashboard/merchnat/all-summery')}}';">
			<div class="core-box">
				<div class="heading">
					<i class="clip-clip circle-icon circle-red"></i>
					<h2>Merchant Summery</h2>
				</div>
			</div>
		</div>


		<div class="col-md-3"  onclick="location.href='{{url('/dashboard/merchnat-coupon/transaction/list')}}';">
			<div class="core-box">
				<div class="heading">
		...
		<div class="col-md-3"  onclick="location.href='{{url('/dashboard/merchnat-buy/coupon/list')}}';">
			<div class="core-box">
				<div class="heading">
