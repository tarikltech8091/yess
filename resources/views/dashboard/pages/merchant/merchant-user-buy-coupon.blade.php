	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="row">
					<form method="get" action="{{url('/dashboard/merchnat-buy/coupon/list')}}">
					...
					<div class="col-md-2" style="margin-top:22px;">
						<a href="{{url('/dashboard/transaction/pdf/from-'.(isset($_GET['search_from']) ? $_GET['search_from'] : date('Y-m-d')).'/to-'.(isset($_GET['search_to']) ? $_GET['search_to'] : date('Y-m-d')).'/bid-'.(isset($_GET['branch_name'])?$_GET['branch_name']:'0'))}}" class="btn btn-success">PDF Download</a>
					</div>
				</div>
