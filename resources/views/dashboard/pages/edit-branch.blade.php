	...
	<div class="row margin_top_20">
		<div class="col-sm-6">
			...
			<div class="panel panel-default">
				...
				<form method="post" action="{{url('/dashboard/branch/update-'.$edit_branch_info->branch_id)}}" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<select class="form-control" name="merchant_id">
							...
							<option {{($edit_branch_info->merchant_id == $list->merchant_id) ? "selected" :''}} value="{{$list->merchant_id}}">{{$list->merchant_name}}</option>
							@endforeach
							@endif
						</select>
					</div>
					...
					<div class="form-group">
						...
						<input type="text" id="form-field-3" class="form-control" name="branch_name" value="{{$edit_branch_info->branch_name}}">
					</div>

					<div class="form-group">
						<label> Branch Code <span class="symbol required"></span></label>
						<input type="text" id="form-field-3" class="form-control" name="branch_code" value="{{$edit_branch_info->branch_code}}">
					</div>
					<div class="form-group">
						<label> Branch Mobile <span class="symbol required"></span></label>
						<input type="text" id="form-field-3" class="form-control" name="branch_mobile" value="{{$edit_branch_info->branch_mobile}}">
					</div>
					<div class="form-group">
						<label> Branch GPRS Lat </label>
						<input type="text" id="form-field-3" class="form-control" name="branch_gprs_lat" value="{{$edit_branch_info->branch_gprs_lat}}">
					</div>
					<div class="form-group">
						<label> Branch GPRS Lng </label>
						<input type="text" id="form-field-3" class="form-control" name="branch_gprs_lng" value="{{$edit_branch_info->branch_gprs_lng}}">
					</div>
					<div class="form-group">
						<label> Branch Email <span class="symbol required"></span></label>
						<input type="text" id="form-field-3" class="form-control" name="branch_email" value="{{$edit_branch_info->branch_email}}">
					</div>
					<div class="form-group">
						<label> Branch City </label>
						<input type="text" id="form-field-3" class="form-control" name="branch_city" value="{{$edit_branch_info->branch_city}}">
					</div>
					<div class="form-group">
						<label> Branch Address <span class="symbol required"></span></label>
						<textarea class="form-control" name="branch_address" cols="50" rows="3">{{$edit_branch_info->branch_address}}</textarea>
					</div>
