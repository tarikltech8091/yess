	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form method="get" action="{{url('/message/request/list')}}">
					...
					<div class="row">
						...
						<div class="col-md-2" style="margin-top:22px;">
							<div class="form-group">
								<input type="submit" class="btn btn-primary" data-toggle1="tooltip" title="Search Contact Message" value="Search">
							</div>
						</div>
					</div>
				</form>	
				...
				<div class="table-responsive">
					<table class="table table-hover table-bordered table-striped nopadding" id="sample-table-1">
						...
						<tbody class="cost_list">
							@if(!empty($message_request_info) && count($message_request_info) > 0)
							@foreach($message_request_info as $key => $list)
							<tr >
								<td>{{$key+1}}</td>
					...
					{{isset($message_request_pagination)?$message_request_pagination:''}}
				</div>
