	...
	<div class="row margin_top_20">
		<div class="col-sm-5">
			...
			<div class="panel panel-default">
				...
				<form method="post" action="{{url('/dashboard/merchant/featured')}}" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<textarea name="product_featured_description" class="form-control" rows="6"></textarea>
					</div>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="product_original_price" value="{{old('product_original_price')}}">
					</div>
				...
				<div class="table-responsive">
					...
					<tbody>
						...
						<tr >
							...
							<td>
								<a href="{{url('/dashboard/merchant/featured/edit-',$list->featured_product_id)}}" class="btn btn-green btn-xs tooltips"><i class="fa fa-pencil-square-o" aria-hidden="true" data-toggle1="tooltip" title="Sub Mercnant Featured  Edit"></i></a>
								<a href="{{url('/dashboard/merchant/featured/delete-',$list->featured_product_id)}}" class="btn btn-xs btn-bricky tooltips"><i class="fa  fa-trash-o" data-toggle1="tooltip" title="Mercnant Featured Delete"></i></a>
							</a>
						</td>
					</tr>
					@endforeach
